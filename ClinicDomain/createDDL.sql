...
CREATE TABLE PROVIDER (NPI BIGINT NOT NULL, NAME VARCHAR(255), SPECIALIZATION VARCHAR(255), PRIMARY KEY (NPI))
CREATE TABLE RadiologyTreatment_DATES (RadiologyTreatment_ID BIGINT, DATES VARCHAR(255))
